...
func (i *Investor) IncreaseAssetPositionByAmount(assetID string, amount int) {
	i.UpdateAssetPosition(assetID, amount)
}

func (i *Investor) DecreaseAssetPositionByAmount(assetID string, amount int) {
	i.UpdateAssetPosition(assetID, -amount)
}
